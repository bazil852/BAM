          ...
          <div className="w-[30%] md:w-[60%] sm:w-full sm:p-3 ssm:w-full ">
            ...
            <div className="w-full h-full flex flex-col mt-3">
              ...
              <input
               ...
               placeholder:text-slate-400 outline-none border-none  bg-[#6C0B6E]/60 placeholder:font-body font-body"
            ...
            <button
              className="bg-[#6C0B6E] outline-none border-none py-3 px-5 rounded-xl font-body cursor-pointer  duration-250 ease-in-out hover:transform-x-1 hover:drop-shadow-xl hover:shadow-sky-600 w-full mt-8 transition transform hover:-translate-y-3 motion-reduce:transition-none motion-reduce:hover:transform-none "
              onClick={resellToken}
              disabled={btnLoading}
            >
