...
const Profile = () => {
  ...
  return (
    <div className="relative  ">
      ...
      <div className="bg-[#110F17] absolute left-[-250px] top-[-210px] h-[352px] w-[652px] blur-[350px] rounded-full font-body"></div>

      <div className="relative overflow-hidden">
        <section className="">
          <div className="max-w-[1400px] relative h-[280px] mx-auto my-0 bg-[#272D37]/60 rounded-2xl border-3 border-solid border-[#4f1552] sm:h-[150px] md:mx-2 ">
