...
const Create = () => {
  ...
  async function handleFileChange(e) {
    ...
    console.log("TYPE IS  ",getFileType(uploadedFile));
  ...
  if (!bundlrInstance) {
    return (
      <div className="justify-center items-center h-screen flex font-body flex-col">
        ...
        <button
          className="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 
    ...
    <div className="font-body">
      ...
      <div className="relative overflow-hidden">
        <section className="max-w-[1024px] my-20 mx-auto grid grid-cols-2  gap-10 font-body  overflow-hidden top-7 md:gap-10 medium md:px-5 sm:grid-cols-1 sm:h-full relative ">
          <div
            className="w-full bg-[#272D37]/60 rounded-3xl sm:h-[350px] border border-solid border-purple-700 cursor-pointer"
          ...
          <div className="w-full flex flex-col font-body gap-5">
            ...
            <div className="flex flex-col">
              ...
              <textarea
                placeholder="eg.Fast Nu is one of the top universities of pakist......."
            ...
            <button
              type="button"
              className="bg-purple-500 outline-none border-none py-3 px-5 rounded-xl font-body cursor-pointer transition duration-250 ease-in-out  hover:drop-shadow-xl hover:shadow-sky-600 w-auto focus:scale-90"
